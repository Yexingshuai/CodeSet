...
public class CountdownView2 extends TextView implements Runnable {
    ...
    public CountdownView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
